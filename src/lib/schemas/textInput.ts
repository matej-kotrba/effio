...
export const programmingDescriptionSchema = z.string().min(ANSWER_MIN, `Description has to be at least ${PROGRAMMING_DESCRIPTION_MIN} character long.`).max(ANSWER_MAX, `Description can be max ${PROGRAMMING_DESCRIPTION_MAX} characters long.`)
