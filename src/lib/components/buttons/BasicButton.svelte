...
<button
	...
	class={twMerge(
		`isolate shadow-lg shadow-light_text_black_20 relative border-none
		 flex items-center duration-150 hover:bg-light_primary dark:hover:bg-dark_primary hover:text-white text-light_primary dark:text-dark_primary
		  gap-2 btn bg-light_primary dark:bg-dark_primary before:content-[''] hover:before:scale-y-0
			 before:origin-top before:duration-150 before:absolute before:inset-1 before:bg-white
