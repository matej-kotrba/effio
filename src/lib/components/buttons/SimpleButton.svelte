<script lang="ts">
	...
	export let variant: 'highlight' | 'filled' | 'ghost' = 'highlight';
	export let type: 'primary' | 'basic' = 'basic';
...
<button type="button" on:click={onClick} class={twMerge(styles, classes)}>
	<slot />
</button>
